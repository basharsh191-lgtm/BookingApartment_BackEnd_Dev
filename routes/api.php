...
Route::get('/user/profileShow/{id}',[ProfileController::class,'showProfile']);
Route::put('/user/profileUpdate',[ProfileController::class,'UpdateProfile'])->middleware('auth:sanctum');
